					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="register-form" action="registerCheck.jsp" method="post" role="form" style="display: block;">
									<button type = "button" id = "btn" class = "btn btn-default has-feedback" >중복확인</button>
