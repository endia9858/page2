...
<c:if test = "${id==null}">
	<% pageContext.setAttribute("idWord", "아이디"); %>
</c:if>
<c:if test = "${email==null}">
	<% pageContext.setAttribute("emailWord", "이메일"); %>
</c:if>
<c:if test = "${password==null}">
	<% pageContext.setAttribute("passwordWord", "비밀번호"); %>
</c:if>
<c:if test = "${confirm==null}">
	<% pageContext.setAttribute("confirmWord", "비밀번호 확인"); %>
</c:if>
<body>
	<style type = "text/css">
.panel-login {
			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form id="login-form" action="loginCheck.jsp" method="post" role="form" style="display: none;">
									<div class="form-group">
										<input type="text" name="username" id="username" tabindex="1" class="form-control" placeholder="아이디">
									</div>
									<div class="form-group">
								...
								<form id="register-form" action="ex1.jsp" method="post" role="form" style="display: block;">
									<div class="form-group has-feedback">
										<input type="text" name="username" id="username1" tabindex="1" class="form-control" placeholder="${idWord}">
										<span></span>
										<button type = "button" id = "btn" class = "btn btn-default has-feedback" value = "overlap"></button>
									</div>
									<div class="form-group has-feedback">
										<input type="email" name="email" id="email1" tabindex="1" class="form-control" placeholder="${emailWord}" >
										<span></span>
									</div>
									<div class="form-group has-feedback">
										<input type="password" name="password" id="password1" tabindex="2" class="form-control" placeholder="${passwordWord}">
										<span></span>
									</div>
									<div class="form-group has-feedback">
										<input type="password" name="confirmpassword" id="confirmpassword" tabindex="2" class="form-control" placeholder="${confirmWord}">
										<span></span>
									</div>
									<div class="form-group has-feedback">
										<div class="row">
